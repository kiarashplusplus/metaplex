...
const RoyaltiesStep = (props: {
  ...
  const [creators, setCreators] = useState<Array<UserValue>>([
    {
      key: '2Tqc43YCjMxim4SVpiKUFqewJ4Jhip2hqf4c9t4YXCoa',
      label: '2Tqc...XCoa',
      value: '2Tqc43YCjMxim4SVpiKUFqewJ4Jhip2hqf4c9t4YXCoa',
    },
  ]);
  const [fixedCreators, setFixedCreators] = useState<Array<UserValue>>([]);
  const [royalties, setRoyalties] = useState<Array<Royalty>>([
    { creatorKey: '2Tqc43YCjMxim4SVpiKUFqewJ4Jhip2hqf4c9t4YXCoa', amount: 10 },
  ]);
